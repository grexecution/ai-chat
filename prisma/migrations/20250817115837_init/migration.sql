...
-- CreateIndex
CREATE UNIQUE INDEX "Folder_userId_position_key" ON "public"."Folder"("userId", "position");
...
-- AddForeignKey
ALTER TABLE "public"."Conversation" ADD CONSTRAINT "Conversation_folderId_fkey" FOREIGN KEY ("folderId") REFERENCES "public"."Folder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
